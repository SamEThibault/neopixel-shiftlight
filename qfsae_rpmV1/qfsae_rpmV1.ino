...
#define REDLINE 7500  // define the engine speed's limit
...
uint16_t green = strip.Color(0, BRIGHTNESS, 0);
uint16_t red = strip.Color(BRIGHTNESS, 0, 0);
uint16_t blue = strip.Color(0, 0, BRIGHTNESS);

// test values
float currEngineSpeed[11] = {1000.0, 2000.0, 3000.0, 4000.0, 5000.0, 6000.0, 7000.0, 7300.0, 7400.0, 7450.0, 7500.0};
